...
public class QrBitmapCreator {
    ...
    public static Bitmap createQRCodeBitmap(String content, Bitmap portrait, int widthAndHeight, int portraitSize) {
        ...
        try {
            ...
            if (portrait != null) {
                createQRCodeBitmapWithPortrait(bitmap, initPortrait(portrait));
            }
            return bitmap;
    ...
    public static Bitmap createQRCodeBitmap(String content, Bitmap portrait) {
        ...
        // 设置编码方式
        qrParam.put(EncodeHintType.CHARACTER_SET, "UTF-8");
        qrParam.put(EncodeHintType.QR_VERSION, 30);// 最高支持40
     ...
     * 初始化头像图片
     */
    public static Bitmap initPortrait(Bitmap portrait) {
        // 对原有图片压缩显示大小
