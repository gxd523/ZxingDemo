...
public class ScannerView extends View {
    ...
    public void onDraw(final Canvas canvas) {
        ...
        Rect rect = new Rect();
        textPaint.getTextBounds(getResources().getString(R.string.scan_qr_code_warn), 0,
                getResources().getString(R.string.scan_qr_code_warn).length(), rect);
        canvas.drawText(getResources().getString(R.string.scan_qr_code_warn), ScreenUtil.getWidthPixels() / 2,
                frame.bottom + rect.height() + ScreenUtil.dpToPx(getContext(), 7), textPaint);
